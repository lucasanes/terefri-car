    ...
    <S.Container>
      <S.Body>
        <S.Text>
          ...
          equipe está comprometida em fornecer informações claras e precisas
          sobre cada veículo em nosso estoque, desde a sua condição mecânica até
          o histórico de manutenção. Queremos que você se sinta confiante ao
          tomar uma decisão de compra conosco.
          <br /> <br />
          Além disso, priorizamos a qualidade dos carros que oferecemos. Todos
          os veículos em nosso showroom passam por uma rigorosa inspeção para
          ...
          Car, entendemos que cada cliente tem necessidades únicas quando se
          trata de adquirir um veículo. Por isso, oferecemos diferentes opções
          de pagamento para atender a diversos perfis de compradores:
        </S.Text>
        <br />
        ...
        <S.Text>
          ...
          fácil acesso para clientes de toda a região. Venha nos fazer uma
          visita e conhecer pessoalmente nossa variedade de carros populares e
          nossas opções de pagamento.
          <br />
